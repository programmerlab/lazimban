        ...
        @section('content') 
                	...
                	<div class="col-md-3">
                    	...
                    	<div class="careerfy-search-filter-wrap">
                            ...
                            <div id="slider-range" class="filter_content"></div>
																						...
																						<input type="hidden" id="" name="category" readonly  class="filter_content" value="{{$category_slug}}">
																<div class="careerfy-search-filter-wrap">
                <h3>Marka</h3>
            ...
            <div class="careerfy-search-filter-wrap">
                ...
                <div class="careerfy-checkbox-toggle">
                    <ul class="careerfy-checkbox filter_size">
                                                            <li>
                                        <input value="Red" name="color[]" class="color filter_content" type="checkbox"><i class="fa fa-circle red"></i><label>Red</label>
                                    </li>
