...
class SettingsController extends Controller {
    ...
    { 
        ...
        return view('packages::setting.edit', compact('setting','website_title','website_email','website_url','contact_number','company_address','banner', 'page_title', 'page_action','helper','meta_key','meta_description','google_tag','google_analytic'));
