...
class HomeController extends Controller
{
 ...
 /*----------*/
    ...
    public function about_us()
    {
         $products = Product::with('category')->orderBy('id','asc')->get();
        $categories = Category::nested()->get();
        $about_page =  \DB::table('pages')->where('slug','about')->get();
        
        return view('end-user.about',compact('categories','products','category','about_page'));         
    }
    ...
    public function privacy_policy()
    {
         $products = Product::with('category')->orderBy('id','asc')->get();
        $categories = Category::nested()->get();
        $privacy_page =  \DB::table('pages')->where('slug','privacy-policy')->get();
        
        return view('end-user.privacy_policy',compact('categories','products','category','privacy_page'));         
    }
    ...
    public function returns()
    {
         $products = Product::with('category')->orderBy('id','asc')->get();
        $categories = Category::nested()->get();
        $delivery_page =  \DB::table('pages')->where('slug','delivery-and-returns')->get();
          
        return view('end-user.returns',compact('categories','products','category','delivery_page'));         
    }
    ...
    public function sales_contract()
    {
         $products = Product::with('category')->orderBy('id','asc')->get();
        $categories = Category::nested()->get();
        $sales_page =  \DB::table('pages')->where('slug','distance-sales-contract')->get();
        
        return view('end-user.sales_contract',compact('categories','products','category','sales_page'));         
    }
    ...
    public function contact()
    {
         $products = Product::with('category')->orderBy('id','asc')->get();
        $categories = Category::nested()->get();
        $contact_page =  \DB::table('pages')->where('slug','contact')->get();
        
        return view('end-user.contact',compact('categories','products','category','contact_page')); 
