...
class SocialmediaController extends Controller {
    ...
    { 
        ...
        return view('packages::social-media.edit', compact('setting','website_title','website_email','website_url','contact_number','company_address','banner', 'page_title', 'page_action','helper','meta_key','meta_description','google_tag','google_analytic'));
    ...
    public function create(Settings $setting) 
    {
        ...
        return view('packages::social-media.create', compact('setting','website_title','website_email','website_url','contact_number','company_address','banner', 'page_title', 'page_action','helper'));
     }
    ...
    public function store(SettingRequest $request, Settings $setting) 
    {
       ...
       return Redirect::to(route('socialmedia'))
    ...
    public function edit(Settings $settings) {
        ...
        return view('packages::social-media.edit', compact( 'categories','product', 'page_title', 'page_action'));
    }
