                            ...
                            <div class="row">
                                <div class="box">
                                    <div class="box-header"> 
                                         ...
                                         <form action="{{url('admin/redirect-301')}}" method="get">
                                        ...
                                        <table class="table table-striped table-hover table-bordered">
                                            <thead>
                                                ...
                                                @foreach($u as $key => $value)
                                                    ...
                                                    <form action="{{url('admin/redirect-301')}}" method="post">
                                                        <tr>
                                                            <th>{{++$key}}</th> 
                                                            <th>301</th>
                                                            ...
                                                            <th> <input type="text" class="form-control" name="old_url" readonly=""  value="{{$value->old_slug or $value->slug}}"> </th>
                                                     ...
                                                     @foreach($value->product as $key2 => $result)
                                                        ...
                                                        <form action="{{url('admin/redirect-301')}}" method="post">
                                                            <tr>
                                                                ...
                                                                <th> <input type="text" class="form-control" name="old_url" readonly=""  value="{{$result->old_url or $result->url}}"> </th>
