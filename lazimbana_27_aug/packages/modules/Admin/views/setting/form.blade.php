...
<hr> <center> <b> Banner  (minimum size : 800x350) </b> </a><hr>
    ...
    <div class="form-group{{ $errors->first('google_tag', ' has-error') }}">
        <label class="col-lg-4 col-md-4 control-label">Google Tag Script</label>
        <div class="col-lg-8 col-md-8"> 
            {!! Form::textarea('google_tag',isset($google_tag->field_value)?$google_tag->field_value:' ', ['class' => 'form-control form-cascade-control input-small'])  !!} 
            <span class="label label-danger">{{ $errors->first('google_tag', ':message') }}</span>
        </div>
    </div>
        
    <div class="form-group{{ $errors->first('google_analytic', ' has-error') }}">
        <label class="col-lg-4 col-md-4 control-label">Google Analytic Script</label>
        <div class="col-lg-8 col-md-8"> 
            {!! Form::textarea('google_analytic',isset($google_analytic->field_value)?$google_analytic->field_value:' ', ['class' => 'form-control form-cascade-control input-small'])  !!} 
            <span class="label label-danger">{{ $errors->first('google_analytic', ':message') }}</span>
        </div>
    </div>
     <hr> <center> <b> Social Media Links </b> </a><hr>
    ...
    <div class="form-group{{ $errors->first('linkedin_id', ' has-error') }}">
        <label class="col-lg-4 col-md-4 control-label"> Linkedin Id <span class="error">*</span></label>
        <div class="col-lg-8 col-md-8"> 
            {!! Form::text('linkedin_id',isset($linkedin_id->field_value)?$linkedin_id->field_value:null, ['class' => 'form-control form-cascade-control input-small'])  !!} 
            <span class="label label-danger">{{ $errors->first('linkedin_id', ':message') }}</span>
        </div>
    </div>
    <div class="form-group{{ $errors->first('pinterest_id', ' has-error') }}">
        <label class="col-lg-4 col-md-4 control-label"> Pinterest Id <span class="error">*</span></label>
        <div class="col-lg-8 col-md-8"> 
            {!! Form::text('pinterest_id',isset($pinterest_id->field_value)?$pinterest_id->field_value:null, ['class' => 'form-control form-cascade-control input-small'])  !!} 
            <span class="label label-danger">{{ $errors->first('pinterest_id', ':message') }}</span>
        </div>
    </div>
    <div class="form-group{{ $errors->first('instagram_id', ' has-error') }}">
        <label class="col-lg-4 col-md-4 control-label"> Instagram Id <span class="error">*</span></label>
        <div class="col-lg-8 col-md-8"> 
            {!! Form::text('instagram_id',isset($instagram_id->field_value)?$instagram_id->field_value:null, ['class' => 'form-control form-cascade-control input-small'])  !!} 
            <span class="label label-danger">{{ $errors->first('instagram_id', ':message') }}</span>
        </div>
    </div>
    <div class="form-group{{ $errors->first('youtube_id', ' has-error') }}">
        <label class="col-lg-4 col-md-4 control-label"> Youtube Channel Id <span class="error">*</span></label>
        <div class="col-lg-8 col-md-8"> 
            {!! Form::text('youtube_id',isset($youtube_id->field_value)?$youtube_id->field_value:null, ['class' => 'form-control form-cascade-control input-small'])  !!} 
            <span class="label label-danger">{{ $errors->first('youtube_id', ':message') }}</span>
        </div>
    </div>
    <div class="form-group{{ $errors->first('google_id', ' has-error') }}">
        <label class="col-lg-4 col-md-4 control-label"> Google Plus Id <span class="error">*</span></label>
        <div class="col-lg-8 col-md-8"> 
            {!! Form::text('google_id',isset($google_id->field_value)?$google_id->field_value:null, ['class' => 'form-control form-cascade-control input-small'])  !!} 
            <span class="label label-danger">{{ $errors->first('google_id', ':message') }}</span>
        </div>
    </div>
    <div class="form-group{{ $errors->first('flicker_id', ' has-error') }}">
        <label class="col-lg-4 col-md-4 control-label"> Flicker Id <span class="error">*</span></label>
        <div class="col-lg-8 col-md-8"> 
            {!! Form::text('flicker_id',isset($flicker_id->field_value)?$flicker_id->field_value:null, ['class' => 'form-control form-cascade-control input-small'])  !!} 
            <span class="label label-danger">{{ $errors->first('flicker_id', ':message') }}</span>
        </div>
    </div>
    <div class="form-group{{ $errors->first('skype_id', ' has-error') }}">
        <label class="col-lg-4 col-md-4 control-label"> Skype Id <span class="error">*</span></label>
        <div class="col-lg-8 col-md-8"> 
            {!! Form::text('skype_id',isset($skype_id->field_value)?$skype_id->field_value:null, ['class' => 'form-control form-cascade-control input-small'])  !!} 
            <span class="label label-danger">{{ $errors->first('skype_id', ':message') }}</span>
        </div>
    </div>
