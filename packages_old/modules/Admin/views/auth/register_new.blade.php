  ...
  <div class="container">
                <div class="container_bg row">
                    <div id="wrapper">
                          ...
                          <div class="page-wrapper">
                              <div class="col-md-5 col-sm-5">
                                  <ul class="woocom">
                                      ...
                                      <li class="topcart">
                                        <a href="{{ url('/checkout') }}">Sepet<span class="cart-counts"></span></a>
                                                        ...
                                                        <tr>
                                                            <td colspan='3'>
                                                                <div class="sub-total">
                                                                    ...
                                                                    <span class="amount"> Genel Toplam :  £ </b> </span>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </tfoot>
                      ...
                      <header>
                          <div class="page-wrapper">
                              <div class="col-md-4"><a href="{{ url('/') }}" class="logo"><img src=""></a></div>
                              <div class="col-md-8">
